...
#
#
m4 -DTITLE="Sum up array, averaging 30 runs" -DFILENAME1="summation_1st" \
	-DFILENAME2="summation_2nd" -DFILENAME3="summation_3rd" \
	-DFILE="summation" gnuplot.gpi | gnuplot
m4 -DTITLE="Sum up array using median, median out of 30 runs" -DFILENAME1="summation_median_1st" \
	-DFILENAME2="summation_median_2nd" -DFILENAME3="summation_median_3rd" \
	-DFILE="summation.median" gnuplot.gpi | gnuplot
m4 -DTITLE="Sum up array, fastest out of 30 runs" -DFILENAME1="summation_smallest_1st" \
